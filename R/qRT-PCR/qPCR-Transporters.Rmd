...
subtitle: "Analysis of chronic morphine effect on P-gp and Bcrp"
author: "C-T Berezin"
date: "10/30/2021"
output:
...
c_bcrp_plot
#ggsave(filename="../../figures/qRT-PCR/c_bcrp_tiss_effect_plot.png", plot=c_bcrp_plot, height=4, width=4)
#ggsave(filename="../../figures/qRT-PCR/c_bcrp_tiss_effect_plot.svg", plot=c_bcrp_plot, height=4, width=4)
...
c_bcrp_log_plot <- ggplot() +
  ...
  geom_point(data=chronic, aes(x=Treatment, y=log2(Bcrp.RGE), fill=Tissue),
             size=2, stat="identity", position=position_dodge(width=0.75)) +
  #facet_grid(~Tissue, scales="free_y") +
...
c_bcrp_log_plot
#ggsave(filename="../../figures/qRT-PCR/c_bcrp_log_plot_large.svg", plot=c_bcrp_log_plot, height=5, width=6)
#ggsave(filename="../../figures/qRT-PCR/c_bcrp_log_plot.svg", plot=c_bcrp_log_plot, height=4, width=4)
...
c_bcrp_tiss_plot <- ggplot() +
  ...
  xlab("") +
  ylab(expression(log[2](RGE[Bcrp])))
...
#ggsave(filename="../../figures/qRT-PCR/c_bcrp_tiss_log_plot_large.png", plot=c_bcrp_tiss_log_plot, height=6, width=6)
```
...
pgp_log_plot1
ggsave(filename = "../../figures/pgp_log_plot_trt1_large.svg", plot = pgp_log_plot1, height=6, width=6)
```
