...
```{r}
transporters <- read.csv("../../data/qRT-PCR/07222022-transporter-gene-study-males-only.csv", fileEncoding = 'UTF-8-BOM')
...
transporters <- transporters %>% mutate(Treatment = factor(Treatment, c("S", "M", "C")),
...
anova(transporter_lm)

emmeans::emmeans(transporter_lm, pairwise ~ Treatment | Tissue, by="gene")$contrasts
emmeans::emmeans(transporter_lm, pairwise ~ Tissue | Treatment, by="gene")$contrasts
emmeans::emmeans(transporter_lm, pairwise ~ gene | Treatment, by="Tissue")$contrasts
```
...
#ggsave(filename="../../figures/qRT-PCR/trans_hyp_ret_males.png", plot=trans_hyp_ret_plot, height=4, width=6)
#ggsave(filename="../../figures/qRT-PCR/trans_hyp_ret_males.svg", plot=trans_hyp_ret_plot, height=4, width=6)
...
#ggsave(filename="../../figures/qRT-PCR/trans_trt_males.png", plot=trans_trt_plot, height=4, width=6)
#ggsave(filename="../../figures/qRT-PCR/trans_trt_males.svg", plot=trans_trt_plot, height=4, width=6)
...
#ggsave(filename="../../figures/qRT-PCR/trans_gene_to_gene_males.png", plot=trans_g2g_plot, height=4, width=6)
#ggsave(filename="../../figures/qRT-PCR/trans_gene_to_gene_males.svg", plot=trans_g2g_plot, height=4, width=6)
