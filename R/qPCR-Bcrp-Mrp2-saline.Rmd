...
```{r}
#read in the data
bm_data <- read.csv("//Mac/Home/Documents/R_coding/data/Mrp-Bcrp-gene-study-subset-sal-ret-only.csv", fileEncoding = 'UTF-8-BOM')
...
#ggsave("//Mac/Home/Documents/R_coding/figures/bcrp_mrp2_plot.png", plot=bm_plot, height=4, width=4)
